...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/mokoMvvmFlowSwiftUI/mokoMvvmFlowSwiftUI.xcframework" "" "true" "ios-arm64_x86_64-simulator/mokoMvvmFlowSwiftUI.framework"
  install_xcframework "${PODS_ROOT}/mokoMvvmFlowSwiftUI/mokoMvvmFlowSwiftUI.xcframework" "" "false" "ios-arm64/mokoMvvmFlowSwiftUI.framework"
fi
